...
import { ContactUsSectionFragmentFragment } from '@/utils/graphql-types';

export type ContactUsSectionProps = ContactUsSectionFragmentFragment & {
    sectionIndex: number;
};

export function ContactUsSection(props: ContactUsSectionProps) {
    return (
        <section {...toFieldPath(`.${props.sectionIndex}`)} className="bg-white dark:bg-gray-900">
